    ...
    public class MonoBehaviourSystem : MonoBehaviour
    {
            ...
            where T1 : MonoBehaviourComponentData
        {
            foreach (var component1 in Entity.GetComponents<T1>())
            {
                ...
                if (component1.gameObject.scene.handle != gameObject.scene.handle) continue;
        ...
        public IEnumerable<Tuple<T1>> GetAllEntities<T1>()
            where T1 : MonoBehaviourComponentData
        {
            foreach (var component1 in Entity.GetComponents<T1>())
            {
        ...
        public IEnumerable<Tuple<T1, T2>> GetAllEntities<T1, T2>()
            where T1 : MonoBehaviourComponentData
            where T2 : MonoBehaviourComponentData
        {
            foreach (var component1 in Entity.GetComponents<T1>())
        ...
        public IEnumerable<Tuple<T1, T2, T3>> GetAllEntities<T1, T2, T3>()
            where T1 : MonoBehaviourComponentData
            where T2 : MonoBehaviourComponentData
            where T3 : MonoBehaviourComponentData
        {
        ...
        public IEnumerable<Tuple<T1, T2, T3, T4>> GetAllEntities<T1, T2, T3, T4>()
            where T1 : MonoBehaviourComponentData
            where T2 : MonoBehaviourComponentData
            where T3 : MonoBehaviourComponentData
            where T4 : MonoBehaviourComponentData
